...
public class ApiCallCtrl {
    ...
    private void loadDefaultPolicy() {
        ...
        loadHelper("* android.net.NetworkInfo.isConnected", ApiCallCtrlPolicy.BLOCK, LogInformLevel.MIDDLE);
        ...
        loadHelper("* android.net.wifi.WifiManager.addNetwork", ApiCallCtrlPolicy.BLOCK, LogInformLevel.MIDDLE);
        loadHelper("* android.net.wifi.WifiManager.disconnect", ApiCallCtrlPolicy.BLOCK, LogInformLevel.MIDDLE);
        loadHelper("* android.net.wifi.WifiManager.getConfiguredNetworks", ApiCallCtrlPolicy.BLOCK, LogInformLevel.MIDDLE);
        loadHelper("* android.net.wifi.WifiManager.getWifiState", ApiCallCtrlPolicy.BLOCK, LogInformLevel.MIDDLE);
        loadHelper("* android.net.wifi.WifiManager.isWifiEnabled", ApiCallCtrlPolicy.BLOCK, LogInformLevel.MIDDLE);
        loadHelper("* android.net.wifi.WifiManager.reconnect", ApiCallCtrlPolicy.BLOCK, LogInformLevel.LOW);
        loadHelper("* android.net.wifi.WifiManager.removeNetwork", ApiCallCtrlPolicy.BLOCK, LogInformLevel.LOW);
        loadHelper("* android.net.wifi.WifiManager.setWifiEnabled", ApiCallCtrlPolicy.BLOCK, LogInformLevel.LOW);
        loadHelper("* android.net.wifi.WifiManager.updateNetwork", ApiCallCtrlPolicy.BLOCK, LogInformLevel.LOW);
